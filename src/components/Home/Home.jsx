    ...
    <div>
      ...
      <div className="mt-16">
        ...
        <div className="flex justify-center">
          <p className="w-2/3 text-cyan-900 text-center">
            Our most popular classes offer a dynamic blend of creativity and skill-building,
            providing students with a rewarding musical experience.
          </p>
        </div>
      </div>
